    ...
    const data = [
      {
        ...
        img: avatar3,
        set1: [{ id: 1, name: "Jame Baker", designation: "UI/UX Designer" }],
      },
      {
        id: 2,
        name: "Mickie Reyes",
          ...
          <Card>
            ...
            <CardBody>
              <p className="text-muted">
                ...
                class to set a nested list with sortable items where images are
                attached within a list-group-item div element.
              </p>
