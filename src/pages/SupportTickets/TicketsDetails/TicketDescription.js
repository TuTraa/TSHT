        ...
        <Card>
          <CardBody className="p-4">
            ...
            <p className="text-muted">
              It would also help to know what the errors are - it could be
              something simple like a message saying delivery is not available
              which could be a problem with your shipping templates. Too much or
              too little spacing, as in the example below, can make things
              unpleasant for the reader. The goal is to make your text as
              comfortable to read as possible. On the note of consistency, color
              consistency is a MUST. If you’re not trying to create crazy
              contrast in your design, then a great idea would be for you to use
              a color palette throughout your entire design. It will
              subconsciously interest viewers and also is very pleasing to look
              at.{" "}
              <Link to="#" className="link-secondary text-decoration-underline">
                Example
              </Link>
            </p>
            <h6 className="fw-semibold text-uppercase mb-3">
                  ...
                  <div className="d-flex mt-4">
                    ...
                    <div className="flex-grow-1 ms-3">
                      ...
                      <p className="text-muted">
                        ...
                        email filters have identified the email from Dell as
                        spam.
                      </p>
                      <Link to="#" className="badge text-muted bg-light">
                        <i className="mdi mdi-reply"></i> Reply
              ...
              <div className="d-flex">
                ...
                <div className="flex-grow-1 ms-3">
                  ...
                  <p className="text-muted">
                    ...
                    help manage your order refer to the “Action Menu” to
