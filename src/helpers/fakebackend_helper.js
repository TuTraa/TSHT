...
//TAG
export const getAPIListTag = (offset, limit) =>
  api.get(url.GET_LIST_TAG, { offset, limit });
...
//Account
export const getAPIListAccount = (offset, limit) =>
  api.get(url.GET_LIST_ACCOUNT, { offset, limit });
export const searchGetAPIListAccount = (
  user_name,
  full_name,
  email,
  phone,
  ...
  api.get(url.SEARCH_GET_LIST_ACCOUNT, {
    user_name,
    full_name,
    email,
    phone,
...
export const getAPIAccountInfo = () =>
  api.get(url.GET_ACCOUNT_BY_ID, { user_id: 1 });
...
//comment
export const getAPIListComment = (offset, limit) =>
  api.get(url.GET_LIST_COMMENT, { offset, limit });
...
export const getAPIDeleteComment = (_comment_id) =>
  api.get(url.DEL_COMMENT, { _comment_id });
...
export const getAPILiveChannelUpdateStatus = () =>
  api.get(url.GET_UPDATE_STATUS);
export const getAPILiveChannelUpdateDRMStatus = () =>
  api.get(url.GET_UPDATE_DRM_STATUS);
...
export const getAPIEpgGetListByChannelId = (offset, limit, _channel_id) =>
